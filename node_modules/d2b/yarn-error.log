Arguments: 
  /usr/local/bin/node /usr/local/Cellar/yarn/1.0.2/libexec/bin/yarn.js add -D core-js

PATH: 
  /Applications/Postgres.app/Contents/Versions/9.6/bin:/Users/kevinwarne/.rbenv/shims:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Library/TeX/texbin
...
npm manifest: 
  {
    ...
    "scripts": {
      "build:dev": "npm run build:package && rollup -c -g d3:d3,d3-sankey:d3,d3-interpolate-path:d3,d3-svg-annotation:d3 && npm run test",
      "build:prod": "npm run build:package && NODE_ENV=production rollup -c -g d3:d3,d3-sankey:d3,d3-interpolate-path:d3,d3-svg-annotation:d3",
...
Lockfile: 
  ...
  d3-interpolate-path@^2.0.1:
    version "2.0.1"
    resolved "https://registry.yarnpkg.com/d3-interpolate-path/-/d3-interpolate-path-2.0.1.tgz#f4d9c2192921fdc11fe474a04ec59645b53b4f5d"
    dependencies:
  ...
  d3-polygon@1.0.3, d3-polygon@^1.0.3:
    version "1.0.3"
  ...
  d3-svg-annotation@^2.1.0:
    version "2.1.0"
    resolved "https://registry.yarnpkg.com/d3-svg-annotation/-/d3-svg-annotation-2.1.0.tgz#648adf944af0a6130e2a9f59543a7b841a36ec4e"
    dependencies:
      d3-dispatch "1.0.2"
      d3-drag "1.0.2"
      d3-selection "1.0.2"
  ...
  flubber@^0.4.0:
    version "0.4.0"
    resolved "https://registry.yarnpkg.com/flubber/-/flubber-0.4.0.tgz#4b5bbf4aaf9306c5ffbf91a60689299c0b8d3866"
    dependencies:
      d3-array "^1.2.0"
      d3-polygon "^1.0.3"
      earcut "^2.1.1"
  ...
  postcss-triangle@^1.0.1:
    version "1.0.1"
    resolved "https://registry.yarnpkg.com/postcss-triangle/-/postcss-triangle-1.0.1.tgz#20f64401a79122a67b0d8b2326b4729091211655"
    dependencies:
      postcss "^5.0.2"
  ...
  postcss@^5.0.0, postcss@^5.0.10, postcss@^5.0.11, postcss@^5.0.12, postcss@^5.0.13, postcss@^5.0.14, postcss@^5.0.16, postcss@^5.0.19, postcss@^5.0.2, postcss@^5.0.21, postcss@^5.0.3, postcss@^5.0.4, postcss@^5.0.5, postcss@^5.0.8, postcss@^5.1.1, postcss@^5.2.0, postcss@^5.2.12, postcss@^5.2.16, postcss@^5.2.17:
    version "5.2.18"
  ...
  rollup-pluginutils@^1.2.0, rollup-pluginutils@^1.3.1, rollup-pluginutils@^1.5.0:
    version "1.5.2"
  ...
  rollup@0.27:
    version "0.27.1"
    resolved "https://registry.yarnpkg.com/rollup/-/rollup-0.27.1.tgz#739931b0784cf00c274b9512d2c852e42055a257"
    dependencies:
      chalk "^1.1.1"
      minimist "^1.2.0"
  ...
  xmlhttprequest@1, "xmlhttprequest@>= 1.6.0 < 2.0.0":
    version "1.8.0"
...
Trace: 
  Error: EACCES: permission denied, mkdir '/Users/kevinwarne/Documents/My_Repos/d2b/node_modules/babel-register/node_modules/core-js'
